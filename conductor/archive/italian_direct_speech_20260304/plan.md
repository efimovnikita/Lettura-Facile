...
**Phase 2: Implementation of Enhanced Splitting Logic [checkpoint: a04aed6]**
...
- [x] Task: Refactor the regex and splitting logic for better readability and maintainability.
- [x] Task: Conductor - User Manual Verification 'Phase 2: Implementation of Enhanced Splitting Logic' (Protocol in workflow.md)

**Phase 3: Quality Assurance and Coverage**
- [x] Task: Run the full test suite and ensure code coverage for `src/utils.ts` is >80%.
- [x] Task: Verify the UI correctly renders the newly split sentences by manually testing with the provided Italian examples.
- [x] Task: Conductor - User Manual Verification 'Phase 3: Quality Assurance and Coverage' (Protocol in workflow.md)
